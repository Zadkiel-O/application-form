...
$sql = "SELECT id, first_name, middle_name, last_name, extension_name, personal_email, profile_photo, student_signature, guardian_signature FROM applicants ORDER BY id DESC";
...
<body class="bg-purple-200">
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                $fullName = $row["first_name"] . " " . 
                                        ...
                                        $row["last_name"] . " " . 
                                        ($row["extension_name"] ? $row["extension_name"] : "");                                echo "<tr class='bg-white'>";
                                ...
                                echo "<td class='border border-black p-2 text-center'>" . 
                                    ($row["profile_photo"] ? "<img src='uploads/" . htmlspecialchars($row["profile_photo"]) . "' class='w-16 h-16 object-cover mx-auto'>" : "No photo") . 
                                    "</td>";
                                echo "<td class='border border-black p-2 text-center'>" . 
                                    ($row["student_signature"] ? "<img src='uploads/" . htmlspecialchars($row["student_signature"]) . "' class='w-16 h-16 object-cover mx-auto'>" : "No signature") . 
                                    "</td>";
                                echo "<td class='border border-black p-2 text-center'>" . 
                                    ($row["guardian_signature"] ? "<img src='uploads/" . htmlspecialchars($row["guardian_signature"]) . "' class='w-16 h-16 object-cover mx-auto'>" : "No signature") . 
                                    "</td>";
                                echo "<td class='border border-black p-2 text-center'>
    ...
    </div>    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
